...
namespace dc
{
    ...
    public class ConnAppProc
    {
        ...
        protected bool m_is_res_loaded = false;   //资源准备好
        ...
        public int Send(PacketBase packet)
        {
            if (packet is PackBaseS2S)
                ((PackBaseS2S)packet).server_uid.ws_uid = ServerConfig.net_info.server_uid;

            return ServerNetManager.Instance.Send(conn_idx, packet);
        }
        /// <summary>
        /// 处理消息
        /// </summary>
        ...
        public bool is_res_loaded
        {
            get { return m_is_res_loaded; }
            set { m_is_res_loaded = value; }
        }
